...
public class ReportCondition extends Controller {
    ...
    public  Result addReportCondition() {
    ...
    public  boolean addReportJunction(Connection conn, int reportID, int withinInterchangeID, int junctionID, int intersectionTypeID, int schoolBusRelatedID) {
    ...
    public  boolean addReportWorkzone(Connection conn, int reportID, int workzoneRelatedID, int workzoneLocationID, int workzoneTypeID, int workersPresentID, int lawEnforcementPresentID) {
        Logger.debug("Inserting ReportJunction...");
    ...
    public  Result updateReportCondition(int reportConditionID) {
    ...
    public  boolean updateReportJunction(Connection conn, int reportID, int withinInterchangeID, int junctionID, int intersectionTypeID, int schoolBusRelatedID) {
    ...
    public  boolean updateReportWorkzone(Connection conn, int reportID, int workzoneRelatedID, int workzoneLocationID, int workzoneTypeID, int workersPresentID, int lawEnforcementPresentID) {
        Logger.debug("Updating ReportJunction...");
    ...
    public  void debugMap(Map<String, String[]> values) {
