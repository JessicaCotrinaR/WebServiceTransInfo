 ...
 */
    ...
    public  Result getHarmfulEvents() {
    ...
    public  Result getHarmfulEventCategories() {
    ...
    public  Result getRelativeToTrafficways() {
    ...
    public  Result getMannerOfCollisions() {
    ...
    public  Result getWeatherConditions() {
    ...
    public  Result getLightingConditions() {
    ...
    public  Result getEnvironmentConditions() {
    ...
    public  Result getRoadCircumstances() {
    ...
    public  Result getWithinInterchanges() {
    ...
    public  Result getIntersectionTypes() {
    ...
    public  Result getSchoolBusRelated() {
    ...
    public  Result getWorkzoneRelated() {
    ...
    public  Result getWorkzoneLocation() {
    ...
    public  Result getWorkersPresent() {
    ...
    public  Result getLawEnforcementPresent() {
    ...
    */
    ...
    public  Result getPersonTypeCategories() {
    ...
    public  Result getDriverLicenseTypes() {
    ...
    public  Result getVehicleJurisdictions() {
    ...
    public  Result getSpecialFunctions() {
    ...
    public  Result getEmergencyUses() {
    ...
    public  Result getDirectionsOfTravel() {
    ...
    public  Result getTrafficwayDescriptions() {
    ...
    public  Result getTotalLanesCategories() {
    ...
    public  Result getRoadwayHorizontalAlignments() {
    ...
    public  Result getRoadwayGrades() {
    ...
    public  Result getInitialContactPoints() {
    ...
    public  Result getExtentOfDamages() {
    ...
    public  Result getVehicleCircumstances() {
    ...
    public  Result getMotorCarrierTypes() {
    ...
    public  Result getVehicleMovements() {
    ...
    public  Result getDriverIsAuthorized() {
    ...
    public  Result getInspectionUpToDate() {
    ...
    public  Result getSpecialPermits() {
    ...
    public  Result getCargoBodyTypes() {
    ...
    public  Result getHazMatInvolved() {
    ...
    public  Result getPlacardDisplayed() {
    ...
    public  Result getHazMatReleased() {
    ...
    public  Result getSeatingOthers() {
    ...
    public  Result getRestraintSystems() {
    ...
    public  Result getAirbagDeployed() {
    ...
    public  Result getSpeedingSuspected() {
    ...
    public  Result getContribActionsCircumstances() {
    ...
    public  Result getActionsPriorToCrash() {
    ...
    public  Result getActionsAtTimeOfCrash() {
    ...
    public  Result getNonMotoristLocations() {
...
GET     /drugTestResults            controllers.Collections.getDrugTestResults()
    ...
    public  Result getSafetyEquipments() {
    ...
    public  Result getSubstancesSuspected() {
    ...
    public  Result getAlcoholTestTypes() {
    ...
    public  Result getAlcoholTestResults() {
    ...
    public  Result getDrugTestTypes() {
    ...
    public  Result getDrugTestResults() {
    ...
    public  Result getTransportedBy() {
    ...
    public  Result getCollection(String table, GetRows callback) {
