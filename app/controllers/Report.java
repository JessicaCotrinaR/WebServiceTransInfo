...
public class Report extends Controller {
    ...
    public  boolean addReportInvolvedUnit(Connection conn, int reportID, int vehicleQuantity, int motoristQuantity, int pedestrianQuantity, int injuredQuantity, int fatalitiesQuantity) {
    ...
    public  boolean addReportLocation(Connection conn, int reportID, float latitude, float longitude, int cityID, int countyID, String streetHighway, double distance, int measurementID, int directionID, int nearToID, String intersectingStreet) {
    ...
    public  Result updateReport(int reportID) {
    ...
    public  boolean updateReportInvolvedUnit(Connection conn, int reportID, int vehicleQuantity, int motoristQuantity, int pedestrianQuantity, int injuredQuantity, int fatalitiesQuantity) {
    ...
    public  boolean updateReportLocation(Connection conn, int reportID, float latitude, float longitude, int cityID, int countyID, String streetHighway, double distance, int measurementID, int directionID, int nearToID, String intersectingStreet) {
