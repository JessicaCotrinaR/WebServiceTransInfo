...
//        final Map<String, String[]> values = request().body().asJson();
        final JsonNode values = request().body().asJson();

        if (values != null && values.has("username") && values.has("password")) {
...
//            String password = values.get("password")[0];
            ...
            try {
                ...
                try {
                    ...
                    Logger.info("Cannot close the connection after crazy loop");
                }
            }
        } else {
            json.put("success", false);
